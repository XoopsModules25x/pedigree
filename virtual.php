...
function virt()
{
    ...
    $numdog = 'SELECT count(d.id) FROM ' . $xoopsDB->prefix('pedigree_tree') . ' d LEFT JOIN ' . $xoopsDB->prefix('pedigree_tree') . ' m ON m.id = d.mother LEFT JOIN ' . $xoopsDB->prefix('pedigree_tree'
