...
$GLOBALS['xoopsTpl']->assign([
                                 ...
                                 'orpall'       => '<a href="result.php?f=father=0 and mother&w=zero&o=pname">' . strtr(_MA_PEDIGREE_ADV_ORPALL, ['[animalTypes]' => $configs['animalTypes']]) . '</a>',
                                 'orpdad'       => '<a href="result.php?f=mother!=0 and father&w=zero&o=pname">' . strtr(_MA_PEDIGREE_ADV_ORPDAD, [
                                         '[father]'      => $configs['father'],
                                         '[animalTypes]' => $configs['animalTypes'],
                                     ]) . '</a>',
                                 'orpmum'       => '<a href="result.php?f=father!=0 and mother&w=zero&o=pname">' . strtr(_MA_PEDIGREE_ADV_ORPMUM, [
